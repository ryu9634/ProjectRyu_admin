(function($) {
	...
	window.doznutadmin = window.doznutadmin || {};
	window.doznutadmin.App = new App;
}(jQuery));
(function(namespace, $) {
	"use strict";
	...
	p._handleMenuToggleClick = function(e) {
		if (!doznutadmin.App.isBreakpoint('xs')) {
	...
	p._handleMenubarLeave = function() {
		...
		if (doznutadmin.App.minBreakpoint('md')) {
			if ($('body').hasClass('menubar-pin')) {
				return;
			}
		}
		$('#menubar').data('expanded', false);
		if (doznutadmin.App.isBreakpoint('xs') === false) {
	...
	window.doznutadmin.AppNavigation = new AppNavigation;
}(this.doznutadmin, jQuery));
(function(namespace, $) {
	"use strict";
	...
	window.doznutadmin.AppOffcanvas = new AppOffcanvas;
}(this.doznutadmin, jQuery));
(function(namespace, $) {
	"use strict";
	...
	window.doznutadmin.AppCard = new AppCard;
}(this.doznutadmin, jQuery));
(function(namespace, $) {
	"use strict";
	...
	window.doznutadmin.AppForm = new AppForm;
}(this.doznutadmin, jQuery));
(function(namespace, $) {
	"use strict";
	...
	window.doznutadmin.AppNavSearch = new AppNavSearch;
}(this.doznutadmin, jQuery));
(function(namespace, $) {
	"use strict";
	...
	p._initScroller = function() {
		...
		$.each($('.scroll'), function(e) {
			var holder = $(this);
			doznutadmin.AppVendor.addScroller(holder);
		});
		doznutadmin.App.callOnResize(function() {
			$.each($('.scroll-xs'), function(e) {
				var holder = $(this);
				if (!holder.is(":visible")) return;
				if (doznutadmin.App.minBreakpoint('xs')) {
					doznutadmin.AppVendor.removeScroller(holder);
				} else {
					doznutadmin.AppVendor.addScroller(holder);
				}
			});
			$.each($('.scroll-sm'), function(e) {
				var holder = $(this);
				if (!holder.is(":visible")) return;
				if (doznutadmin.App.minBreakpoint('sm')) {
					doznutadmin.AppVendor.removeScroller(holder);
				} else {
					doznutadmin.AppVendor.addScroller(holder);
				}
			...
			$.each($('.scroll-lg'), function(e) {
				var holder = $(this);
				if (!holder.is(":visible")) return;
				if (doznutadmin.App.minBreakpoint('lg')) {
					doznutadmin.AppVendor.removeScroller(holder);
				} else {
					doznutadmin.AppVendor.addScroller(holder);
				}
	...
	window.doznutadmin.AppVendor = new AppVendor;
}(this.doznutadmin, jQuery));