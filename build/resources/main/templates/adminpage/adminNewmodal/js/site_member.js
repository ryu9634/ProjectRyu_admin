...
var SITE_MEMBER = function(){
	...
	var openINICISWindow = function(mid, Tradeid, Okurl, call_back_data){ // 본인인증, 성인인증 (이니시스) 팝업창
		...
		var auth_url ='https://cas.inicis.com/casapp/ui/cardauthreq?mid=' + mid + '&Siteurl=' + Siteurl + '&Tradeid=' + Tradeid + '&Closeurl=' + Okurl + '&Okurl=' + Okurl + '&MSTR=' + MSTR;
			...
			success: function(res){
				if(res.msg === 'SUCCESS'){
					if(IS_APP || IS_MOBILE){
						...
						windowOpen('COMBINATIONAUTHTYPESWindow', auth_url, 400, 620, 'yes', 'post');
					}
				}
			}
		});
